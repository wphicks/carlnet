...
struct ValueNodeFixture {
  shared_ptr<IntNode> node0 = make_shared<IntNode>();
  shared_ptr<IntNode> node1 = make_shared<IntNode>();
  shared_ptr<IntNode> node2 = make_shared<IntNode>();
  shared_ptr<IntNode> node3 = make_shared<IntNode>();
  set<shared_ptr<IntNode>> node_set;
  ValueNodeFixture() {
...
BOOST_AUTO_TEST_CASE(iterator_constructor_test) {
  ...
  IntNode test_node {node_fix.node_set.begin(), node_fix.node_set.end()};
